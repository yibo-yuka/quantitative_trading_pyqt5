...
class mainwin(QtWidgets.QWidget):
    ...
    def strategy_ui(self):
        ...
        self.tacticCheckbtn1 = QtWidgets.QCheckBox("頂背離",self)
        ...
        self.tacticCheckbtn3 = QtWidgets.QCheckBox("底背離",self)
        ...
        self.min_5_kbar_cb = QtWidgets.QCheckBox("5分K",self)
        self.min_5_kbar_cb.setEnabled(False)
        self.min_10_kbar_cb = QtWidgets.QCheckBox("10分K",self)
        self.min_10_kbar_cb.setEnabled(False)
        self.hr_1_kbar_cb = QtWidgets.QCheckBox("小時K",self)
        self.hr_1_kbar_cb.setEnabled(False)
        self.day_kbar_cb = QtWidgets.QCheckBox("日K",self)
        self.day_kbar_cb.setChecked(True)
        self.left_Vlayout7.addWidget(self.min_5_kbar_cb)
        self.left_Vlayout7.addWidget(self.min_10_kbar_cb)
        self.left_Vlayout7.addWidget(self.hr_1_kbar_cb)
        self.left_Vlayout7.addWidget(self.day_kbar_cb)
    ...
    def backTesting(self):
        ...
        #df = pd.read_excel('TX_2023-10-01_2025-03-31_info.xlsx')
